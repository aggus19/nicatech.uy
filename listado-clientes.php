...
<head>
	<base href="" />
	<title>Panel - Listado de Clientes</title>
	<meta charset="utf-8" />
			...
			<div id="kt_app_header" class="app-header " data-kt-sticky="true"
				...
				<div class="app-container  container-fluid d-flex align-items-stretch justify-content-between "
					...
					<ol class="breadcrumb breadcrumb-line text-muted fs-6 fw-semibold">
						...
						<li class="breadcrumb-item text-muted">Listado de Clientes</li>
					</ol>
							...
							<div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true"
								...
								<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
									...
									<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											<div class="menu-item">
												<a class="menu-link active" href="./listado-clientes">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							<div id="kt_app_content_container" class="app-container container-fluid">
								<div class="d-flex justify-content-between align-items-center mb-4">
									<p class="fw-semibold fs-5 text-gray-500 mb-0">Estás viendo el listado de clientes registrados en el sistema.</p>
								...
								<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
									...
									<tbody>
										<?php foreach ($clientes as $cliente): ?>
											<tr>
												<td class="text-gray-600">#<?php echo $cliente['cliente_id']; ?></td>
												...
												<td class="text-center">
													<a href="editar-cliente?id=<?php echo $cliente['cliente_id']; ?>" class="btn btn-sm btn-light-primary">Editar</a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
				...
				<div class="modal-body">
					<form id="nuevoClienteForm">
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="nombre" name="nombre" value="Agustín" required>
						</div>
						<div class="mb-3">
							<label for="apellido" class="form-label">Apellido</label>
							<input type="text" class="form-control" id="apellido" name="apellido" value="Fagúndez" required>
						</div>
						<div class="mb-3">
							<label for="telefono" class="form-label">Numero de teléfono celular</label>
							<input type="text" class="form-control" id="telefono" name="telefono" pattern="\d{0,9}" maxlength="9" value="093593066" required>
						</div>
						<div class="mb-3">
							<label for="correo" class="form-label">Correo electrónico</label>
							<input type="email" class="form-control" id="correo" name="correo" value="agustintesting@nicatech.uy" required>
						</div>
					</form>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-light" data-bs-dismiss="modal">Cerrar</button>
					<button type="submit" class="btn btn-primary" form="nuevoClienteForm">Guardar cambios</button>
				</div>
			</div>
		</div>
	</div>
	...
	<script defer>
		...
		var KTDatatablesExample = function() {
			...
			var exportButtons = function() {
				const documentTitle = 'Listado de Clientes';
		...
		document.getElementById('nuevoClienteForm').addEventListener('submit', function(event) {
			...
			fetch('api/crear_nuevo_cliente', {
				...
				.then(data => {
					...
					if (data.success) {
						...
						toastr.success("Cliente agregado correctamente", "Éxito");

						// Cerrar el modal después de un pequeño retraso para permitir que se vea el toastr
						setTimeout(() => {
				...
				.catch(error => {
					toastr.error(`Hubo un error al intentar agregar el cliente. ${error}`, "Error");
				});
		});
	</script>
</body>
